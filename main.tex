...
episode ends with a \texttt{finish} call or a plain reply. Changing \emph{only} the harness for a fixed instruction-tuned model and task
...
\claudecode{} accuracy on \swev{} from $69.0\%$ to $78.4\%$ but does not improve its \codexcli{} accuracy ($68.0\%$ before, $66.7\%$
...
control's harness, is ahead under every
unseen production harness by up to $8.7$ points, and is on a par with

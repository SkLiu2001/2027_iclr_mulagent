...
some
with meaningless tool names, so that one harness's data trains an agent
for any harness with no new task data.
...
harnesses from $7.4$ to $1.6$ points, and is on a par with training
on real trajectories from four harnesses. Harness variation is thus a nuisance
...
The four harnesses aforementioned all let an agent run shell commands and edit files,

...
\paragraph{Strength of evidence.} Each cell of Table~\ref{tab:e1} averages
three evaluations, but the two models are compared against a noise floor, and
each model is a single training run. One of the ten cells favours the control
...
Section~\ref{sec:real}, Figure~\ref{fig:real} & Qwen3-30B-A3B-Instruct-2507 & \method{} of Appendix~\ref{app:e1-30b}, real-trajectory model & four production, \cham{} & V, M & 1 & Appendix~\ref{app:e1-30b} conditions for \claudecode{} and \opencode{}, separate runs elsewhere \\
...
Section~\ref{sec:axes}, Figure~\ref{fig:axes} & Qwen3-30B-A3B-Instruct-2507 & \method{} of Appendix~\ref{app:e1-30b}, control & \cham{}, seven surfaces & M & 1 & separate runs; unfinished episodes excluded \\
Appendix~\ref{app:e1-30b}, Table~\ref{tab:e1-30b} & Qwen3-30B-A3B-Instruct-2507 & \method{}, control & \claudecode{}, \opencode{} & V, M & 1 & Appendix~\ref{app:e1-30b} conditions \\
\bottomrule
\end{tabular}
\end{footnotesize}
\end{center}

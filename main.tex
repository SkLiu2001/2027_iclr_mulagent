...
harness interfaces, verified with zero mismatches in \numroundtrip{} render--parse
checks over \numactions{} real actions. Building on this representation, we introduce \method{}
...
action sequence exactly, measured at \rtacc{} in \numroundtrip{} render--parse
checks over all \numactions{} actions (Section~\ref{sec:protocol}). This is a \emph{descriptive} claim about
...
\item \textbf{The \HP{}, with an exactness guarantee that is measured rather
  ...
  calls from four harnesses; surface rendering is exactly invertible on those
  calls, verified in \numroundtrip{} render--parse checks
...
three or four randomly sampled surface configurations (``Renderings'') and
parsed back; a check counts as exact when the verb and all arguments match.
...
\toprule
Corpus & Trajectories & Actions & Renderings & Checks & Mismatches & Consistency \\
\midrule
Mixed set (four corpora) & $2{,}832$ & $130{,}537$ & $4$ & $522{,}004$ & $0$ & \rtacc{} \\
\claudecode{} (large) & $5{,}000$ & $295{,}613$ & $3$ & $886{,}407$ & $0$ & \rtacc{} \\
\codexcli{}           & $2{,}041$ & $152{,}706$ & $3$ & $457{,}962$ & $0$ & \rtacc{} \\
\midrule
Total               & $\numtraj{}$ & $\numactions{}$ & & $1{,}866{,}373$ & $\mathbf{0}$ & $\mathbf{\rtacc{}}$ \\
\bottomrule
\end{tabular}
\end{small}
\end{center}
...
as the \HP{}, and verifying that the surface map is exactly invertible on those
calls, in \numroundtrip{} render--parse checks, turns interface variation into
something a training pipeline can marginalize over. \method{} does so with no new task data and no

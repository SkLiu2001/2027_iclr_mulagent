...
the scaffold as a nuisance variable at training time and synthesize its
surfaces from one harness's trajectories, and Section~\ref{sec:real} compares
the two directly.
...
smaller scale on Qwen3-30B-A3B-Instruct-2507 \citep{qwen3,qwen3_30b_card}, with a different
